...
import { Grid, Image, Media, ResponsiveContainingView, PaddingSize, TextAlignment, Stack, Direction, Alignment, Button, KibaIcon, ResponsiveTextAlignmentView, AppDownloadButton } from '@kibalabs/ui-react';
            ...
            <ResponsiveTextAlignmentView alignment={TextAlignment.Center} alignmentMedium={TextAlignment.Left}>
              <Stack direction={Direction.Vertical} paddingEnd={PaddingSize.Wide3} contentAlignment={Alignment.Center} contentAlignmentMedium={Alignment.Start}>
                ...
                {appButtonVariant === 'custom' ? (
                  ...
                  <Stack direction={Direction.Vertical} directionSmall={Direction.Horizontal} shouldAddGutters={true}>
